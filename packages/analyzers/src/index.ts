...
export { OpportunitiesAnalyzer, type OpportunitiesResult, type SearchOpportunity, type GscMetrics, type CruxMetrics, type PageSearchData } from './opportunities.js';
